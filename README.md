...
Python3 virtual environment can later be automatically created from it. The required version of Python3 is installed, but not made active. System-wide Python3 configurations are thus left safely unaltered.
