...
Created project folders have an isolated Python virtual environment, matched to suit the requirements of ESPHome, and distinct from any other Python installation. The prototypical Python version must first be installed, before the isolated 
