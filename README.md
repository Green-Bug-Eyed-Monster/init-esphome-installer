...
To install the `init-esphome` command script in your ~/.local/bin folder, create the directory and add it to your path if it does not already exist, just run the following shell command.
> [!WARNING]
