...
**To initialise a folder for ESPHome development**, creating it if necessary, whilst referencing the given absolute or relative path to the target folder, use:
