...
### Prerequisites
The requisite Python version to run ESPHome changes over time. Check the changelogs to see the minimum Python version you'll need to run ESPHome. 
([https://green.bug-eyed.monster](https://esphome.io/changelog/)) 
