...
```
> [!NOTE]
> If you have any security concerns, please review the install-init-esphome.sh installation script, as well as the init-esphome development environment creation script itself, before invoking the installer.
> 
### Use
