...
Python3 virtual environment can later be automatically created from it. The required version of Python3 is installed, yet not made active. Thus system-wide Python3 configurations are left safely unaltered.
